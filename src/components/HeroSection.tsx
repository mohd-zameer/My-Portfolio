...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative h-[100dvh] min-h-[600px] w-full overflow-hidden bg-black">
      {/* Black hole background — image is perfectly static; only a very
          light brightness breathing is applied, no color/effect added. */}
      <BlackHoleBackground imageSrc="/blackhole-mono.webp" />
        ...
        <div className="flex flex-1 items-center pt-8 sm:pt-12 md:pt-16 pointer-events-none">
          <div className="w-full max-w-7xl px-6 md:px-10 pointer-events-auto">
            <FadeIn delay={0.65} y={30}>
              <h1
                className={`mt-4 sm:mt-6 md:mt-8 text-transparent bg-clip-text bg-gradient-to-r from-white via-[#F1F5F9] to-[#94A3B8] uppercase tracking-[-0.03em] leading-[0.95] whitespace-nowrap drop-shadow-[0_0_30px_rgba(255,255,255,0.18)] drop-shadow-[0_0_15px_rgba(52,211,153,0.12)] transition-all duration-1000 origin-left ${speaking ? 'scale-[0.4] sm:scale-[0.5] font-light opacity-50 pointer-events-none' : 'scale-100 font-black opacity-100'}`}
                style={{ fontSize: 'clamp(1.1rem, 6.5vw, 150px)' }}
              >
                <ScrambleText text="Mohamed Zameer J" delay={0.8} />
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.85} y={20}>
              <div className="mt-5 md:mt-6 flex items-center gap-4">
                ...
                <p className="text-[9px] sm:text-[10px] md:text-xs font-medium uppercase tracking-[0.3em] text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 drop-shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                  Computer Science Engineer <span className="mx-2 text-white/20">|</span> Full Stack Developer <span className="mx-2 text-white/20">|</span> Web Developer
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={1.0} y={20}>
              <div className="mt-8 md:mt-12">
                <a
                  href="/Mohamed_Zameer_J_CV.pdf"
                  download="Mohamed_Zameer_J_CV.pdf"
