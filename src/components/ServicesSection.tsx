...
const SERVICES = [
  {
    ...
    description:
      'Building and optimizing responsive websites and web applications using HTML5, CSS3, JavaScript, PHP, and MySQL, with a focus on clean UI and a smooth user experience.',
  },
  {
    number: '02',
    title: 'Java & Python Programming',
    description:
      'Writing efficient, well-structured code in Java and Python for problem-solving, coursework, and application logic.',
  },
  {
    number: '03',
    title: 'Database Design',
    description:
      'Designing and querying relational databases with MySQL and SQL, connecting them to PHP-based backends for dynamic, data-driven applications.',
  },
  {
    number: '04',
    title: 'Version Control & Collaboration',
    description:
      'Using Git for source control and collaborating with development teams to build, test, and debug features in a structured workflow.',
  },
];
