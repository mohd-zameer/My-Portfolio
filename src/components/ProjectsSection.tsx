...
// TODO: Replace these placeholder images with real screenshots of your projects
// (drop them in /public and update the paths below).
const PROJECTS: ProjectData[] = [
  {
    number: '01',
    category: 'E-Commerce / Internship Project',
    name: 'SalemFarm Mango',
    liveUrl: '#',
    col1Image1: '/salemfarm_1.webp',
    col1Image2: '/salemfarm_2.webp',
    col2Image: '/salemfarm_3.webp',
  },
  {
    number: '02',
