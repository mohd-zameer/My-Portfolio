...
import { Mail, MessageCircle, Linkedin, Github, Send, Code2 } from 'lucide-react';
...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'mohamedzameerofficial26@gmail.com',
    href: 'mailto:mohamedzameerofficial26@gmail.com',
    hoverColor: '#EA4335',
  },
  {
    icon: MessageCircle,
    label: 'Phone',
    value: '+91 86104 25244',
    href: 'tel:+918610425244',
    hoverColor: '#25D366',
  },
  {
    icon: Linkedin,
  ...
  },
  {
    ...
    label: 'GitHub',
    value: '@mohd-zameer',
    href: 'https://github.com/mohd-zameer',
    hoverColor: '#333333',
  },
  {
    icon: Code2,
    label: 'LeetCode',
    value: 'u/Mohd_Zameer07',
    href: 'https://leetcode.com/u/Mohd_Zameer07/',
    hoverColor: '#FFA116',
  },
];
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative z-10 flex h-0 w-0 items-center justify-center overflow-hidden rounded-full border border-white/80 opacity-0 transition-all duration-500 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] group-hover:h-9 group-hover:w-9 group-hover:opacity-100 group-hover:scale-110 group-hover:rotate-[360deg] shadow-[0_0_15px_rgba(255,255,255,0.5)]">
                        <img src="/profile.webp" alt="Mohamed Zameer" className="h-full w-full object-cover" />
                      </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 rounded-[20px] border border-white/10 bg-[#111111]/80 backdrop-blur-md p-6 sm:p-10 shadow-[0_0_40px_rgba(0,0,0,0.3)]">
              ...
              <div className="flex flex-col gap-2 group">
                ...
                <textarea
                  ...
                  placeholder="Hello Zameer, I have an opportunity for you..."
                ></textarea>
              </div>
